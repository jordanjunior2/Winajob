                    ...
                    <div class="page-header-title text-center text-white">
                        ...
                        <div>
                            <ol class="breadcrumb justify-content-center">
                                ...
                                <li class="breadcrumb-item active">Grille de vos Articles</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class=" p-3">
                            <div class="media">
                                ...
                                <div class="media-body ml-2">
                                    <p class="mb-0 text-muted mb-0 f-13"><a href="#" class="text-dark">Ancien.</a></p>
                                    <ul class="list-inline mb-0">
                                ...
                                <div class="p-2">
                                    ...
                                    <ul class="list-inline mb-0">
                                        ...
                                        <li class="list-inline-item float-right">
                                            ...
                                            <a href="{{url('/admin/deletepost',$blog -> id)}}"><i class=""bi bi-trash></i></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
