            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="title text-center mb-4">
                        ...
                        <p class="text-muted mb-1">Quelques unes de nos catégories</p>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="popu-category-box bg-light rounded text-center mt-4 p-4">
                        ...
                        <div class="popu-category-content">
                            ...
                            <p class="text-custom mb-0 rounded"> {{$data -> job -> count()}} </p>
                        </div>
                    </div>
                </div>
                @endforeach
                <div class="col-lg-3 col-md-6">
                    <div class="popu-category-box bg-light rounded text-center mt-4 p-4">
                        ...
                        <div class="popu-category-content">
                            <h5 class="f-18 mb-4"><a href="{{url('/showallcategories')}}" class="text-dark">Toutes Les Offres</a></h5>
