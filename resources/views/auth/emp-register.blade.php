...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><center>{{ __('Inscription Pour Les Recruteurs') }} </center> </div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{url('/employerregister')}}">
                        ...
                        <div class="row mb-3">
                            <label for="cname" class="col-md-4 col-form-label text-md-end">{{ __('Nom De La Société') }}</label>
