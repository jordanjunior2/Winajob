                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-9">
                            <div class="page-header-title text-center text-white mb-5 pb-5">
                                <h1 class="text-uppercase mb-0">Liste des Postulants </h1>
                                <div>
    ...
    <section class="">
        <div class="container">
            ...
            <div class="form-group app-label">
                <label for="date-to" class="text-muted">Programmez la date d'entretien</label>
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    <div class="candidates-img float-left mr-4">
                                        <img src="{{asset('public/files/avatars')}}/{{$user -> profil -> avatar}}" alt="" class="img-fluid d-block rounded">
                                    </div>
                                    <div class="candidates-list-desc job-single-meta  pt-2">
                                        <h5 class="mb-2 f-19"><a href="#" class="text-dark"> {{$user -> name}} </a></h5>
                                        <ul class="list-inline mb-0">
                                            <li class="list-inline-item mr-4">
                                                <p class="text-muted f-15 mb-0"><i class="mdi mdi-account mr-1"></i> {{$user -> profil -> fonction}} </p>
                                            </li>

                                            <li class="list-inline-item mr-4">
                                                <p class="f-15 mb-0"><a href="#" class="text-muted"><i class="mdi mdi-map-marker mr-1"></i> {{$user -> profil -> adresse}} </a></p>
                                            </li>

                                            <li class="list-inline-item">
                                                <p class="text-muted f-15 mb-0"><i class="mdi mdi-currency-usd mr-1"></i> {{$user -> profil -> salaire}} </p>
                                            </li>
                                            <li class="list-inline-item">
                                        ...
                                        <p class="text-muted mt-1 mb-0">Domanies de travail : {{$user -> profil -> experience}} </p>
                                ...
                                <div class="col-md-3">
                                    <div class="candidates-list-fav-btn text-right">
                                        ...
                                        <div class="candidates-listing-btn mt-4">
                                            <a href="{{url('user/showprofile',$user -> id)}}" class="btn btn-outline btn-sm">Voir Profil</a>
                                            <a href="{{url('/selectprofile',$user -> id)}}" class="btn btn-custom btn-sm"><i class="mdi mdi-cloud-plus-circle"></i> Retenir</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-11 offset-lg-1">
                                    <div class="candidates-item-desc">
                                        <hr>
                                        <p class="text-muted mb-2 f-14"> {{\Illuminate\Support\Str::limit($user -> profil -> description,20 )}} </p>
                                    </div>
                                </div>
                            </div>
                        </div>
