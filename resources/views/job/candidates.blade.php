                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-9">
                            <div class="page-header-title text-center text-white mb-5 pb-5">
                                <h1 class="text-uppercase mb-0">Liste des Postulants Retenus</h1>
                                <div>
                                    <ol class="breadcrumb justify-content-center">
                                        <li class="breadcrumb-item"><a href="{{route('accueil')}}">Winajob</a></li>
                                        <li class="breadcrumb-item"><a href="">Candidats</a></li>
                                        <li class="breadcrumb-item active">Liste des Candidats Retenus</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-md-3">
                                    <div class="candidates-list-fav-btn text-right">
                                        ...
                                        <div class="candidates-listing-btn mt-4">
                                            <a href="{{url('/calls/interview')}}" class="btn btn-outline btn-sm">Demarrer</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
