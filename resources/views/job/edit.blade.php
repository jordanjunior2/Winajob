            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="page-header-title text-center text-white">
                        <h1 class="font-weight-light">Editer une Offre</h1>
                        <div>
                            <ol class="breadcrumb justify-content-center">
                                <li class="breadcrumb-item"><a href="{{route('accueil')}}">Winajob</a></li>
                                <li class="breadcrumb-item active">Editer une Offre</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-10">
                    <div class="post-job bg-white p-4">
                        <div class="custom-form">
                            ...
                            <form method="post" action="{{url('/uploadeditjobpost')}}" name="contact-form" id="contact-form3">
                                @csrf
                                <h4 class="text-dark mb-4">Editer une Nouvelle Offre</h4>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group app-label mt-2">
                                            <label for="company-name" class="text-muted">Titre de l'Offre</label>
                                            <input id="company-name" name="titre" type="text" class="form-control resume" placeholder="Titre de l'offre" value="{{$data -> titre}}">
                                            @if($errors->has('titre'))
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group app-label mt-2">
                                            ...
                                            <div class="form-button">
                                                <select name="type" class="nice-select" value="{{$data -> type}}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group app-label mt-2">
                                            ...
                                            <div class="form-button">
                                                <select name="categorie" class="nice-select" value="{{$data -> categorie_id}}">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group app-label mt-2">
                                            ...
                                            <input id="city" name="ville" type="text" class="form-control resume" placeholder="" value="{{$data -> ville}}">
                                            @if($errors->has('ville'))
                                                    <div class="error" style="color:red">
                                                    {{$errors->first('ville')}}
                                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group app-label mt-2">
                                            ...
                                            <div class="form-button">
                                                <input type="text" name="pays" id="" value="Cameroun">
                                                @if($errors->has('pays'))
                                                    <div class="error" style="color:red">
                                                    {{$errors->first('pays')}}
                                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group app-label mt-2">
                                            ...
                                            <input id="minimum-salary" name="salaire_min" type="text" class="form-control resume" placeholder="8000" value="{{$data -> salaire_min}}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group app-label mt-2">
                                            ...
                                            <input id="maximum-salary" name="salaire_max" type="text" class="form-control resume" placeholder="20000" value="{{$data -> salaire_max}}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group app-label mt-2">
                                            ...
                                            <input type="radio" value="deux" name="genre">&nbsp;Les Deux
                                                @if($errors->has('genre'))
                                                    <div class="error" style="color:red">
                                                    {{$errors->first('genre')}}
                                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group app-label mt-2">
                                            ...
                                            <div class="form-button">
                                                <input type="text" name="education" id="" value="{{$data -> education}}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group app-label mt-2">
                                            ...
                                            <div class="form-button">
                                                <select name="annee_experience" class="nice-select" value="{{$data ->annee_experience}}">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group app-label mt-2">
                                            ...
                                            <input id="url" name="website" type="url" class="form-control resume" placeholder="" value="{{Auth::user() -> company -> adresse}}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group app-label mt-2">
                                            ...
                                            <input id="number" type="text" name="phone" class="form-control resume" placeholder="" value="{{$data -> phone}}">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group app-label mt-2">
                                            ...
                                            <div class="form-button">
                                                <select class="nice-select" name="statut">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group app-label mt-2">
                                            ...
                                            <div class="form-button">
                                                <input type="date" name="last_date" id="" class="form-control resume" value="{{$data -> last_date}}">
                                            </div>
                                        </div>
                                    </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group app-label mt-2">
                                            ...
                                            <textarea id="description" name="responsabilites" rows="6" class="form-control resume" placeholder=""> {{$data -> responsabilites}} </textarea>
                                            @if($errors->has('responsabilites'))
                                                    <div class="error" style="color:red">
                                                    {{$errors->first('responsabilites')}}
                                                    </div>
                                                @endif
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group app-label mt-2">
                                            ...
                                            <textarea id="description" name="description" rows="6" class="form-control resume" placeholder=""> {{$data -> description}} </textarea>
                                            ...
                                            <li class="list-inline-item">
                                                <div class="input-group mt-2 mb-2">
                                                    <div class="custom-file">
                                                        ...
                                                        <label class="custom-file-label" name="image" for="inputGroupFile01"><i class="mdi mdi-cloud-upload mr-1"></i> Upload un fichier</label>
                                                    </div>
                                                </div>
                                            </li>

                                            <li class="list-inline-item">
                                                <h6 class="text-muted mb-0">Uploader des Images Ou Documents.</h6>
                                            </li>
                                        </ul>
                                    </div>
                                    @if($errors->has('image'))
